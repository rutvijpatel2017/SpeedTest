#! python2  # This template does not currently support Python 3
#coding: utf-8
...
def shell():
    ...
    #printer('Testing from %(isp)s (%(ip)s)...' % speedtest.config['client'],quiet) //ME
    printer('%(isp)s' % speedtest.config['client'],quiet)
...
#    printer('%(latency)s ms' % results.server)
